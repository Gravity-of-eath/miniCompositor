...
OS_FLAGS = " -DWITH_LINUX_DRM -DWITH_LCD_CLEAR_ALPHA -DWITH_FS_RES -DWITH_STB_FONT -DWITH_STB_IMAGE -DHAS_PTHREAD -DWITH_STB_IMAGE -DHAS_STD_MALLOC -DHAS_STDIO -DWITHOUT_CLIPBOARD -DWITH_NULL_IM"
...
OS_LIBPATH = ["./lib",
              "/develop/toolchain_rk3576/aarch64-buildroot-linux-gnu/lib",
              "/develop/toolchain_rk3576/aarch64-buildroot-linux-gnu/lib64",
              "/develop/toolchain_rk3576/aarch64-buildroot-linux-gnu/sysroot/usr/lib",
              "/develop/toolchain_rk3576/aarch64-buildroot-linux-gnu/sysroot/usr/lib64"]

# compile include paths
# ..example: OS_CPPPATH = ["/path/to/incdir1", "/path/to/incdir2"]
OS_CPPPATH = ["/develop/toolchain_rk3576/aarch64-buildroot-linux-gnu/sysroot/usr/include","/develop/toolchain_rk3576/aarch64-buildroot-linux-gnu/sysroot/usr/include/drm"]
...
TOOLS_PREFIX = "/develop/toolchain_rk3576/bin/aarch64-buildroot-linux-gnu-"
