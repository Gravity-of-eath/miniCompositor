...
# linux's lcd devices type, value is fb/drm/wayland/egl_for_fsl/egl_for_x11/egl_for_gbm/egl_for_wayland/mc_sw
# mc_sw = software (CPU) mc-compositor client: T113 has no GPU/EGL.
# ..example: LCD_DEVICES = "mc_sw"
LCD_DEVICES = "mc_sw"
